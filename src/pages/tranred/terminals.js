            ...
            {query.length ? (
              <>
                ...
                <Grid sx={12} md={4} sm={6}>
                    <Button variant="contained" fullWidth>Ver Histórico</Button>
                  </Grid>
                  <Grid sx={12} md={4} sm={6}>
                    <Button variant="contained" fullWidth>Modificar Cuenta Banco</Button>
                  </Grid>
                  <Grid sx={12} md={4} sm={6}>
                    <Button variant="contained" fullWidth>Cambiar Estatus</Button>
                  </Grid>
                  <Grid sx={12} md={4} sm={6}>
                    <Button variant="contained" fullWidth>Cambiar Serial/Modelo</Button>
                  </Grid>
                  <Grid sx={12} md={4} sm={6}>
